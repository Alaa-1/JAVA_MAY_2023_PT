public class Ninja{
    ...
    public Ninja(String name, Integer health, Weapon weapon, int power){
        this.name = name;
        this.health = health;
        this.weapon = weapon;
        this.power = power;
    ...
    public void displayStats(){
        System.out.println(String.format("Name: %s \n Health: %d \n Weapon: %s \n Power: %d", this.name, this.health, this.weapon.getType(), this.power ));
    }
    ...
    public void attack(Ninja anotherNinja){
        ...
        anotherNinja.setHealth(anotherNinja.getHealth() - this.weapon.getDamage());
